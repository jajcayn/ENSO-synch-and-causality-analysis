...
plt.ylim([-4,4])
p1, = plt.plot(enso.phase, linewidth = 1.7)
plt.plot(enso.amplitude, linewidth = 1.7, color = "#C03634")
plt.plot(enso.amplitude * np.cos(enso.phase), ':', linewidth = 2, color = "#673D00")
# plt.plot(enso.data[12:-12], '--', color = '#2D2F4E', linewidth = 2.5)
...
# plt.show()
plt.savefig("wvlt_example.eps", bbox_inches = "tight")
