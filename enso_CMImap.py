...
def load_enso_SSTs(num_ts = None, PROmodel = False, EMRmodel = None, DDEmodel = None):
    ...
    x, y = r[0.0025][20000:21024, 0], r[0.0025][20000:21024, 1] # x is annual, y is biennal
    ...
    for BINS in bins_list:
        ...
        for CMIP5model in CMIP5models:
            ...
            # for num_ts in model_count:
                ...
                fname = ("conceptualRossler-eps=0.0025-NOsynch-1:2-monthlyEQQ-and-kNN-added-noise.bin")
